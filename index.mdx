---
title: Introduction
description: Product-aligned MantrixFlow documentation for current PostgreSQL, HubSpot, and Stripe Beta ELT workflows.
---

MantrixFlow documents current self-serve ELT workflows in the app: PostgreSQL,
HubSpot, or Stripe Beta source data flows through isolated staging and explicit
SQL models into PostgreSQL.
...
- Stripe Beta source connections
