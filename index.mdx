---
title: Introduction
description: Product-aligned MantrixFlow documentation for database and SaaS ELT workflows, including the GitHub Beta source.
---

MantrixFlow documents current self-serve ELT workflows in the app. PostgreSQL,
MySQL, Airtable, Asana, Linear, Notion, GitHub, Zendesk, HubSpot, or Stripe source data flows through isolated
