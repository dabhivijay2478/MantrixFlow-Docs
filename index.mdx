---
title: Introduction
description: Product-aligned MantrixFlow documentation for PostgreSQL, MySQL, Airtable, Asana, Notion, HubSpot, and Stripe ELT workflows.
---

MantrixFlow documents current self-serve ELT workflows in the app. PostgreSQL,
MySQL, Airtable, Asana, Notion, HubSpot, or Stripe source data flows through isolated
