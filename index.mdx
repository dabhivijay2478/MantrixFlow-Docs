...
- Transformation guides: SQL transforms for PostgreSQL-to-PostgreSQL pipelines, Python script transforms for SaaS sources
...
4. In the builder, pick one table or resource, add an optional SQL or Python transform, and set the destination table.
