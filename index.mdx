...
MantrixFlow currently documents the live self-serve workflow in the app: a PostgreSQL source connection feeding a PostgreSQL destination connection through a DuckDB-staged ELT run.
...
- Destination-scoped dbt SQL models that read from DuckDB raw staging tables
