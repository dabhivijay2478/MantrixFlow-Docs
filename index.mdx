---
title: Introduction
description: Product-aligned MantrixFlow documentation for current PostgreSQL, HubSpot, and Stripe ELT workflows.
---

MantrixFlow documents current self-serve ELT workflows in the app: PostgreSQL,
HubSpot, or Stripe source data flows through isolated staging and explicit
