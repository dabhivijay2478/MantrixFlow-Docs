...
description: Resolve common MantrixFlow connection, discovery, preview, validation, delivery, and billing problems.
---
...
Confirm that the source user can read the expected schema or API resources. For HubSpot and Stripe, verify the required token permissions in the connector reference.
...
Open **Run History**, select the failed Pipeline Run, and use the named phase and error message to identify the next action.
