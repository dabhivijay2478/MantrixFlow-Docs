...
description: "Understand the current MantrixFlow pipeline workspace, destination-owned transformations, readiness validation, runs, and schedules."
---

A MantrixFlow pipeline combines one shared source configuration with one or more
