...
description: "Understand the live MantrixFlow pipeline lifecycle: shell creation, source selection, destination-scoped Normalisation and SQL, manual runs, and Incremental schedules."
---
