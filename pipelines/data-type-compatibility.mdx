...
Use Normalisation casts for simple structural coercion before SQL models run.

Use SQL for more specific conversions, null handling, JSON extraction, or column derivation.
