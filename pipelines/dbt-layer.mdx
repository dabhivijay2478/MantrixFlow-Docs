---
title: dbt Layer
description: Write dbt SQL models in the dbt Layer tab to transform normalised raw data into clean destination tables — for PostgreSQL-to-PostgreSQL pipelines.
---
...
<Note>
  The dbt Layer is available for **PostgreSQL-to-PostgreSQL pipelines**.
</Note>
