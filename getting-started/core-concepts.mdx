---
title: Core Concepts
description: "Current Arcyria concepts: connections, the pipeline workspace, source streams, destination-owned transformations, output assignments, runs, and schedules."
---
