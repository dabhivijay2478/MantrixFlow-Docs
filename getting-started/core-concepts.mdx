...
enabled. Asana, HubSpot, and Stripe are sources.
...
Streams use stable keys such as `public.orders`, `stripe.customers`, or
`airtable.tbl...`. Database staging relations use names such as
`public__orders`.
