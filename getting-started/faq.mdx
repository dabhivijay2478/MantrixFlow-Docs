...
Asana, HubSpot, and Stripe are available as sources. Asana exposes eight
supported streams, Stripe exposes 34, and HubSpot exposes ten. MySQL, Airtable,
and Asana are runtime-capability gated, so the connection picker shows them only
