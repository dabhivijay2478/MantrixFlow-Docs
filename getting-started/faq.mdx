...
PostgreSQL is available as a source and destination. HubSpot and Stripe are
available as sources for PostgreSQL delivery. Stripe exposes 34 supported
streams, and HubSpot exposes ten supported streams.
