...
inside the pipeline builder after the connection is saved.
...
| SQL cannot find the staging table | Use the lowercase staging name shown in the builder, not the visible Airtable table name. |
