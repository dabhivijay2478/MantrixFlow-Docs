...
Strapi is available as a Beta, source-only connector for Strapi 5. MantrixFlow
...
- Strapi is Beta, source-only, and supports Strapi 5 only.
...
- Production readiness still requires live Strapi-to-destination validation.
