...
description: Configure MongoDB as a Beta source, discover collections, preview inferred schemas, and run Full Table or Incremental pipelines.
---

MongoDB is available as a Beta source connector. MantrixFlow uses the official
...
- MongoDB-to-PostgreSQL and MongoDB-to-MongoDB are verified; other SQL
  destination pairings remain Beta until their connector-specific E2E passes.
