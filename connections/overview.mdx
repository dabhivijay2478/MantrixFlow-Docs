...
description: Create and test PostgreSQL, MySQL, Airtable, ClickHouse, Asana, Linear, Notion, HubSpot, and Stripe connections supported by MantrixFlow.
---
...
4. Choose **PostgreSQL**, **MySQL**, **Airtable**, **ClickHouse**, **Asana**, **Linear**, **Notion**, **HubSpot**, or **Stripe**.
5. Fill the connector-specific fields. Airtable and Asana use Personal Access
   ...
   token; HubSpot uses a private app access token.
