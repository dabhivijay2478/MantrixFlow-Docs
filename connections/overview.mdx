...
description: Create and test PostgreSQL, MySQL, Airtable, Asana, Linear, Notion, HubSpot, and Stripe connections supported by MantrixFlow.
---
...
as sources. Asana supports workspace/project scoping, and Notion supports shared
data-source discovery with dlt-backed incremental extraction. Linear is a Beta
source with team/project scope and eight supported resources.
...
4. Choose **PostgreSQL**, **MySQL**, **Airtable**, **Asana**, **Linear**, **Notion**, **HubSpot**, or **Stripe**.
