...
description: Create and test database and SaaS connections supported by MantrixFlow, including Strapi 5 and Zendesk Support.
---
...
4. Choose **PostgreSQL**, **MySQL**, **Airtable**, **ClickHouse**, **DuckDB**, **Asana**, **Linear**, **Notion**, **Zendesk**, **Strapi**, **HubSpot**, or **Stripe**.
5. Fill the connector-specific fields. Airtable and Asana use Personal Access
   ...
   token; Zendesk uses OAuth; Strapi uses a read-only API token; HubSpot uses a
