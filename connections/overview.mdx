...
description: Create and test PostgreSQL, MySQL, Airtable, Asana, Notion, HubSpot, and Stripe connections supported by MantrixFlow.
---
...
data-source discovery with dlt-backed incremental extraction.
...
4. Choose **PostgreSQL**, **MySQL**, **Airtable**, **Asana**, **Notion**, **HubSpot**, or **Stripe**.
5. Fill the connector-specific fields. Airtable and Asana use Personal Access
   Tokens; Notion uses an internal integration token; HubSpot uses a private
   app access token.
