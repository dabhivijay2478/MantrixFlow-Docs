...
Airtable is available as a destination connector for reverse ELT. Arcyria
...
and its fields in Airtable first, then refresh its schema in Arcyria.
...
Arcyria submits records in Airtable-sized batches and performs Upsert with
