...
1. Open **Workspace → Settings → Organization**.
2. If you are the **Owner**, edit the name, slug, or description.
3. Save changes.

Non-owners can still view the organization details there, but the page is read-only for them.
