---
title: Data privacy
description: What Arcyria stores, what it uses transiently during sync and preview, and how operators should handle sensitive data responsibly.
---

Data privacy in Arcyria is mostly about understanding the difference between configuration metadata, operational metadata, and the underlying business data flowing through your pipelines.
...
- destination business data as a separate durable Arcyria dataset

## How data moves during normal operation

1. A pipeline reads from the source.
2. Arcyria applies transform logic and branch configuration.
...
Think of Arcyria as the control plane for movement and transformation, not as the permanent home for your business dataset. That framing leads to better decisions about field selection, masking, and destination governance.
