...
![Transform panel with Python script and branch label](/images/user-guide/ug-transform-panel.png)
...
![Builder showing source, transform, and destination branch](/images/user-guide/ug-pipeline-builder-branches.png)
