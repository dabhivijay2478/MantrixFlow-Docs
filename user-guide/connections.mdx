---
title: Connections
description: Create and test PostgreSQL and HubSpot connections in the MantrixFlow workspace.
---
...
3. Choose **PostgreSQL** or **HubSpot**.
...
guide](/connections/sources/crm/hubspot).
