---
title: Connections
description: Create and test PostgreSQL, MySQL, Airtable, HubSpot, and Stripe connections in the MantrixFlow workspace.
---
...
3. Choose **PostgreSQL**, **MySQL**, **Airtable**, **HubSpot**, or **Stripe**
