...
description: Diagnose common run and configuration issues in the current Arcyria workflow.
---
...
Create the destination table in PostgreSQL before running. Enter the target in Arcyria as `schema.table`.
